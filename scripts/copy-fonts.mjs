...
// the latin files by hand gives us three files, stable URLs we can <link
...
const FONTS = [
  ...
  { pkg: '@fontsource-variable/source-serif-4', file: 'source-serif-4-latin-wght-normal.woff2', out: 'source-serif-4-latin.woff2' },
];
