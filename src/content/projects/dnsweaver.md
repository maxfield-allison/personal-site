...
They hadn't only installed it. They'd found a bug and sent a fix before we ever spoke. Their machines are wired differently to mine, and dnsweaver was confidently picking the wrong network interface because of it. You cannot find that in your own lab. Your lab does the one thing you built it to do.
