...
Approved. The build went into the customer's service catalogue and it's being scoped now, down to a minimum viable copy of two regional clusters so it stays cheap enough that nobody comes looking for it with an axe at budget time.
